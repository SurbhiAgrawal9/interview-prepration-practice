...
for(var i=1;i<=5;i++){   // bcz of var  
    ...
    setTimeout(function(){
           console.log(i); // printing 6 continue in 5 time bcz i is altime refering same spot in memory
    },i* 1000);
} 
}
x();
...
for(let i=1;i<=5;i++){   //let is block scope, in everytime 
    ...
    setTimeout(function(){
           console.log(i);   // printing 1 to 5  bcz i is refering in diffrent memory location (in new copy of i)
    },i* 1000);
}
}
x();
